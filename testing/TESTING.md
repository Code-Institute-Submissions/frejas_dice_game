...
As reusable functions are used throughtout the project. Testing has been a major proiatly!
...
1. Help tool
    * Case: Help tool has been brooken or effects different area.
        * Effect 
...
1. gamePlay function
    1. newDice: As the game is based on using the dice once per round. New dice on you selection was quite importand.
        * Case: The dice on your quick selection has been already used but showing as avaible.
